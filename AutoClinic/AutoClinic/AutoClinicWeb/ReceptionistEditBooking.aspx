<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceptionistEditBooking.aspx.cs" Inherits="AutoClinicWeb.ReceptionistEditBooking" %>
	...
	<form id="form1" runat="server">
		<div class="wrapper">
			...
			<div class="content" id="content">
				...
				<div id="regForm">
                    <div>
                        <asp:GridView ID="dgvBookings" runat="server" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable"></asp:GridView>               
                    </div>
                    <br />
                   <!-- Bottom Buttons -->
                    <div>
                        <asp:DropDownList ID="cmbCustomerSelect" CssClass="textBox" runat="server">
                    ...
                    <!-- Bottom Buttons -->
                    <div>
                        <asp:Button ID="btnSave" CssClass="mainButton" runat="server" Text="Save Changes" />
                        <br />
