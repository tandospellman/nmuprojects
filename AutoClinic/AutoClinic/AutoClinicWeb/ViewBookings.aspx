<%@ Page Language="C#" AutoEventWireup="true" Inherits="AutoClinicWeb.ViewBookings" CodeBehind="ViewBookings.aspx.cs" %>
...
<body>
    <form id="frmViewBooking" runat="server">
        <div class="wrapper">
			<!-- Sidebar -->
				...
				<div id="regForm">
                    <div>
                        <asp:DropDownList AutoPostBack="true" ID="ddlSelectOption" CssClass="textBox" runat="server" OnSelectedIndexChanged="ddlSelectOption_SelectedIndexChanged">
                            ...
                            <asp:ListItem>View by Customer</asp:ListItem>
                            <asp:ListItem>View by Vehicle</asp:ListItem>
                        </asp:DropDownList>
                        <br />
                        <asp:DropDownList AutoPostBack="true" ID="ddlSelectCustomer" CssClass="textBox" runat="server" OnSelectedIndexChanged="ddlSelectCustomer_SelectedIndexChanged">
                            <asp:ListItem>Select a Customer:</asp:ListItem>
                        </asp:DropDownList>
                        <br />
                        <asp:DropDownList AutoPostBack="true" ID="ddlSelectVehicle" CssClass="textBox" runat="server" OnSelectedIndexChanged="ddlSelectVehicle_SelectedIndexChanged">
                            <asp:ListItem>Select a Vehicle:</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div>
                        <asp:GridView ID="dgvBookings" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable" runat="server" Width="80%"></asp:GridView>               
                    </div>
