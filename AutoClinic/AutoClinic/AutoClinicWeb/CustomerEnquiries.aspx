<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerEnquiries.aspx.cs" Inherits="AutoClinicWeb.CustomerEnquiries" %>
...
<body>
    <form id="frmViewQuote" runat="server">
         <div class="wrapper">
			<!-- Sidebar -->
			...
			<div class="content" id="content">
				...
				<div id="regForm">
                    <div>
                        ...
                        <div class="inputContainer" runat="server" id="divSearchByCustomer">
                    ...
                    <div>
                        <asp:GridView ID="dgvQuote" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable" runat="server" Width="80%"></asp:GridView>               
                    </div>
