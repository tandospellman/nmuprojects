<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustBooking.aspx.cs" Inherits="AutoClinicWeb.CustBooking" %>
				...
				<div>
					...
					<div>
                        <div>
                            ...
                            <asp:DropDownList ID="cmbSearchOptions" CssClass="textBox" runat="server">
                                <asp:ListItem>Select Option...</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div>
                            <asp:Label ID="lblVehicle" CssClass ="col-form-label" runat="server" Text="Vehicle ID"></asp:Label>

                            <asp:TextBox ID="txtSearch" CssClass="textBox" runat="server"></asp:TextBox>
                            <br />
                        <div>
                            Service Type<asp:TextBox ID="txtSearch0" CssClass="textBox" runat="server"></asp:TextBox>
                            <br />
                        <div>
                            Prefered Date of Service<asp:TextBox ID="txtSearch1" CssClass="textBox" runat="server"></asp:TextBox>
                        </div>
                        </div>
                        </div>
					</div>
                    <br />
                        <div>
                            Notes/Comments<asp:TextBox ID="txtSearch2" CssClass="textBox" runat="server"></asp:TextBox>
                        </div>
                    ...
                    <!-- Bottom Buttons -->
                    <div>
                        <asp:Button ID="btnSaveBook" CssClass="mainButton" Text="Request Appointment" runat="server" />
                        <asp:Button ID="btnReqQuote" CssClass="mainButton" Text="Request Quote" runat="server" OnClick="btnReqQuote_Click" />
                        <asp:Button ID="btnCancel" CssClass="mainButton" Text="Cancel Booking" runat="server" />
                    </div>
				</div>
			</div>
		</div>
