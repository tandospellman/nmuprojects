<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterCustomer.aspx.cs" Inherits="AutoClinicWeb.RegisterCustomer" %>
		...
		<div class="wrapper">
			...
			<nav class="sidebar" id="sidebar">
				...
				<ul class="list-unstyled components">
					<!-- Home -->
					<li>
						<a href="CustomersPage.aspx">Home</a>
					</li>
					<!-- Customers -->
					<li>
			...
			<div class="content" id="content">
				...
				<div id="regForm">
                    ...
                    <!-- Vehicle Details -->
                    <fieldset id="fsVehicle" runat="server">
