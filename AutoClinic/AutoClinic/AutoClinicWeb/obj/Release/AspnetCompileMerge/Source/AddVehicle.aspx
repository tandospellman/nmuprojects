<%@ Page Language="C#" AutoEventWireup="true" Inherits="AutoClinicWeb.AddVehicle" CodeBehind="AddVehicle.aspx.cs" %>
...
<body>
    <form id="frmAddVehicle" runat="server">
         <div class="wrapper">
			<!-- Sidebar -->
				...
				<div id="regForm" style="position:relative">
                    ...
                    <div runat="server" id="divUpdateCustomer">
                        ...
                        <div runat="server" id="divVehicleInfo">
                            <h3 style="text-align:left; padding-bottom: 1em;">Vehicle Details</h3>
                            <!-- Customer Name-->
                            <div class="inputContainer">
                                <asp:Label runat="server" AssociatedControlID="txtRegNo" Text="Customer Name:"></asp:Label>
                                <asp:DropDownList ID="ddlCustomers" runat="server" CssClass="textBox">
                        ...
                        <!-- Register Button -->
                        <div>
                            <asp:Button ID="btnRegister" CssClass="mainButton" runat="server" Text="Register Vehicle" OnClick="btnRegister_Click" />
