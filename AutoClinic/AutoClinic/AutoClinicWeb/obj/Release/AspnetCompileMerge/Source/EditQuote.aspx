<%@ Page Language="C#" AutoEventWireup="True" Inherits="AutoClinicWeb.EditQuote" Codebehind="EditQuote.aspx.cs" %>
...
<body>
    <form id="frmCreateQuote" runat="server">
        <div class="wrapper">
			<!-- Sidebar -->
				...
				<div id="regForm" style="position:relative; text-align:left">
                    <div>                     
                        <div class="inputContainer">
                            <asp:Label runat="server" AssociatedControlID="txtDateCreated" Text="Date Created:"></asp:Label>
                            <asp:TextBox CssClass="textBox" id="txtDateCreated" runat="server" TextMode="Date"></asp:TextBox>
                        </div>
                        <div class="inputContainer">
                            <asp:Label runat="server" AssociatedControlID="txtTotalCost" Text="Total Cost:"></asp:Label>
                            <asp:TextBox CssClass="textBox" id="txtTotalCost" runat="server"></asp:TextBox>
                        </div>
                        <div class="inputContainer">
                            <asp:Label runat="server" AssociatedControlID="txtDiscount" Text="Discount:"></asp:Label>
                            <asp:TextBox CssClass="textBox" id="txtDiscount" runat="server"></asp:TextBox>
                        </div>
                        <div class="inputContainer">
                            <asp:Label runat="server" AssociatedControlID="chkStatus" Text="Vehicle Arrived:"></asp:Label>
                            <asp:CheckBox ID="chkStatus" CssClass="textBox" runat="server" />
                        </div>
                        <div>
                            <asp:Button ID="btnAdd" CssClass="mainButton" runat="server" Text="Create Quote" OnClick="btnAdd_Click" /> 
                            <br />
