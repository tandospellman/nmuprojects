<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceptionistBookings.aspx.cs" Inherits="AutoClinicWeb.ReceptionistBookings" %>
		...
		<div class="wrapper">
			...
			<div class="content" id="content">
				...
				<div>
                    ...
                    <!-- Bottom Buttons -->
                    <div>
                        <asp:Button ID="btnAddNew" CssClass="mainButton" Text="Add New Booking" runat="server" />
                        <asp:Button ID="btnEditBooking" CssClass="mainButton" Text="Edit Booking" runat="server" />
