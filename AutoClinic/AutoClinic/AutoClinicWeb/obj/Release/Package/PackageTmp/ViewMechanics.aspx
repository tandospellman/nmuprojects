<%@ Page Language="C#" AutoEventWireup="True" Inherits="AutoClinicWeb.ViewMechanics" CodeBehind="ViewMechanics.aspx.cs" %>
        ...
        <div id="wrapper">
			...
			<div class="content" id="content">
				...
				<div id="regForm" style="position:relative">
                    <div>
                        <!-- Elements view active mechanics -->
                        <div id="divViewMechanics" runat="server">
                            <asp:DataGrid ID="dgvActiveMechanics" runat="server" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable" OnSelectedIndexChanged="dgvActiveMechanics_SelectedIndexChanged"></asp:DataGrid>
                        </div>
                    </div>
				</div>
			</div>
