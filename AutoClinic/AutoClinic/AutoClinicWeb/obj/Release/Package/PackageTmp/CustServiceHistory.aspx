<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustServiceHistory.aspx.cs" Inherits="AutoClinicWeb.CustServiceHistory" %>
				...
				<div>
					...
					<div>
                        ...
                        <div>
                            ...
                            <asp:Button ID="btnSearch" CssClass="mainButton" runat="server" Text="Search" />
                        </div>
					</div>

                    <!-- Search Results -->
                    <div>
                        <asp:GridView ID="dgvSearchResults" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable" runat="server"></asp:GridView>
                    </div>

                    <!-- Bottom Buttons -->
                    <div>
                        <asp:Button ID="btnViewHistory" CssClass="mainButton" Text="View Service History" runat="server" />
                        <asp:Button ID="btnReschedule" CssClass="mainButton" Text="Reschedule Appointment" runat="server" />
                        <asp:Button ID="btnCancAppt" CssClass="mainButton" Text="Cancel Appointment" runat="server" />
                    </div>
				</div>
			</div>
		</div>
