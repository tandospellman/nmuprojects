<%@ Page Language="C#" AutoEventWireup="true" Inherits="AutoClinicWeb.ViewVehicles" CodeBehind="ViewVehicles.aspx.cs" %>
        ...
        <div id="wrapper">
			...
			<div class="content" id="content">
				...
				<div id="regForm" style="position:relative">
                    <div>
                        <!-- Elements view vehicles -->
                        <div id="divViewVehicles" runat="server">
                            <asp:DataGrid ID="dgvActiveVehicles" runat="server" AlternatingRowStyle-CssClass="gridAltRow" RowStyle-CssClass="gridRow" HeaderStyle-CssClass="gridHeader" CssClass="gridSearchTable"></asp:DataGrid>
                        </div>
                    </div>
				</div>
			</div>
